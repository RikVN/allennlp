...
from allennlp.modules.seq2seq_decoders.average_lstm_cell_decoder_net import AveragedLstmCellDecoderNet
from allennlp.modules.seq2seq_decoders.marian_lstm_cell_decoder_net import MarianLstmCellDecoderNet
